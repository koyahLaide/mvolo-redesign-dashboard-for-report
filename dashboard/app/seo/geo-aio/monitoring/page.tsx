export default function GeoMonitoringPage() {
  return (
    <div className="max-w-2xl space-y-4">
      <div>
        <h1 className="text-xl font-bold text-gray-900 dark:text-white">GEO Monitoring</h1>
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
          Volg je GEO/AIO-signalen in de tijd.
        </p>
      </div>
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-10 flex flex-col items-center gap-3 text-center">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">
          De monitoring-module wordt in een volgende sprint gebouwd.
        </p>
      </div>
    </div>
  );
