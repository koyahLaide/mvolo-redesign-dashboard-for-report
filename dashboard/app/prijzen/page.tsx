              ...
              <div className="space-y-6">
                ...
                <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden">
                  <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-800">
                    <h2 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Marge per kanaal</h2>
                    <p className="text-xs text-gray-400 dark:text-gray-600 mt-0.5">Gewogen gemiddelde op basis van verkochte SKUs × COGS</p>
                  </div>
                          ...
                          <tr key={ch.channel} className="border-b border-gray-200/50 dark:border-gray-800/50 hover:bg-gray-50 dark:hover:bg-gray-800/20">
                            ...
                            <td className="px-5 py-3">
                              <div className="flex items-center gap-2">
                                <div className="flex-1 h-1.5 bg-gray-200 dark:bg-gray-200 dark:bg-gray-800 rounded-full overflow-hidden max-w-24">
              ...
              <div className="space-y-6">
                  ...
                  <div className="bg-indigo-950/30 border border-indigo-800/40 rounded-xl px-5 py-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {withTests.slice(0, 6).map((p: any) => (
                        <div key={p.sku} className="bg-gray-50 dark:bg-gray-50 dark:bg-gray-900/60 rounded-lg px-4 py-3 border border-gray-200 dark:border-gray-800/40">
                          ...
                          <p className="text-xs text-gray-400 dark:text-gray-600 mt-1">{p.test_advice.reason}</p>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden">
                  <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between">
                    <div>
                      <h2 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Prijs × volume per product</h2>
                      <p className="text-xs text-gray-400 dark:text-gray-600 mt-0.5">Op welke prijs wordt elk product het meest verkocht?</p>
                    </div>
                  </div>
                        ...
                        <div key={p.sku}>
                          ...
                          >
                            <div className="flex items-center gap-3">
                              ...
                              {p.stock !== null && (
                                <span className={`text-xs px-1.5 py-0.5 rounded ${p.stock <= 0 ? 'bg-red-100 dark:bg-red-900/40 text-red-600 dark:text-red-400' : p.stock <= 5 ? 'bg-yellow-100 dark:bg-yellow-900/40 text-yellow-600 dark:text-yellow-400' : 'bg-gray-100 dark:bg-gray-800 text-gray-500'}`}>
                ...
                {Object.entries(data?.channelProducts ?? {}).map(([channel, products]: [string, any]) => {
                  ...
                  return (
                    <div key={channel} className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden">
                      ...
                      <div className="divide-y divide-gray-200/40 dark:divide-gray-800/40">
